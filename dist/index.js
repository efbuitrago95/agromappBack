...
var moons_routes_1 = __importDefault(require("./routes/moons.routes"));
var classification_Items_routes_1 = __importDefault(require("./routes/classification_Items.routes"));
var moon_Items_routes_1 = __importDefault(require("./routes/moon_Items.routes"));
var type_Moons_routes_1 = __importDefault(require("./routes/type_Moons.routes"));
...
app.use("/api/moons", moons_routes_1.default);
app.use("/api/moon_items", moon_Items_routes_1.default);
app.use("/api/classification_items", classification_Items_routes_1.default);
app.use("/api/type_moons", type_Moons_routes_1.default);
