...
var type_Moons_model_1 = __importDefault(require("../models/type_Moons.model"));
var utils_1 = require("../utils");
var numberItems = 10;
var TypeMoonsController = /** @class */ (function () {
    function TypeMoonsController() {
        var _this = this;
        this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var querySql;
            return __generator(this, function (_a) {
                querySql = type_Moons_model_1.default.query();
                if (req.query.search) {
    ...
    return TypeMoonsController;
}());
exports.default = TypeMoonsController;
