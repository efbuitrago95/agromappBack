...
var classification_Items_model_1 = __importDefault(require("../models/classification_Items.model"));
var utils_1 = require("../utils");
var numberItems = 10;
var ClassificationItemsController = /** @class */ (function () {
    function ClassificationItemsController() {
        var _this = this;
        this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var querySql;
            return __generator(this, function (_a) {
                querySql = classification_Items_model_1.default.query().eager('languages');
                if (req.query.search) {
        ...
        this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                classification_Items_model_1.default.query()
                    .insert(req.body)
                    .then(function (data) {
        ...
        this.getById = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                classification_Items_model_1.default.query().eager('languages')
    ...
    return ClassificationItemsController;
}());
exports.default = ClassificationItemsController;
