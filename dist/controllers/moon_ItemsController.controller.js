...
var moon_Items_model_1 = __importDefault(require("../models/moon_Items.model"));
var MoonItemsController = /** @class */ (function () {
    function MoonItemsController() {
        var _this = this;
        this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                moon_Items_model_1.default.query()
                    .then(function (data) {
    ...
    return MoonItemsController;
}());
exports.default = MoonItemsController;
