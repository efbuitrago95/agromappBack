...
var crop_items_model_1 = __importDefault(require("../models/crop_items.model"));
var CropItemsController = /** @class */ (function () {
    function CropItemsController() {
        var _this = this;
        this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                crop_items_model_1.default.query()
                    .then(function (data) {
    ...
    return CropItemsController;
}());
exports.default = CropItemsController;
