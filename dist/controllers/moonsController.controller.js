...
var moons_model_1 = __importDefault(require("../models/moons.model"));
var utils_1 = require("../utils");
var numberItems = 10;
var MoonsController = /** @class */ (function () {
    function MoonsController() {
        var _this = this;
        this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var querySql;
            return __generator(this, function (_a) {
                querySql = moons_model_1.default.query();
                if (req.query.search) {
    ...
    return MoonsController;
}());
exports.default = MoonsController;
